...
-- 연동 문서 §2.5/§2.6/§2.7 예시와 정합. status/tier 는 enum 이름(대문자)으로 저장.
...
INSERT INTO problem (problem_id, display_no, title, tier_name, tier_level, season_id,
    ...
    ('S2-01', 'S2-01', '수 정렬하기',       'SILVER',   'V',  2, 2, 256, 'O(N log N)', 1200, 800,  760,  12),
    ('S2-02', 'S2-02', 'DFS와 BFS',        'SILVER',   'III', 2, 1, 256, 'O(V+E)',     980,  540,  510,  20),
    ('S2-03', 'S2-03', '동적 계획법 입문',   'GOLD',     'V',  2, 1, 256, 'O(N^2)',     740,  300,  280,  8),
    ('S2-08', 'S2-08', '그래프 가중치 처리', 'GOLD',     'IV', 2, 1, 512, 'O(N^4) 이내', 8432, 2791, 2113, 234),
    ('S2-12', 'S2-12', '최소 스패닝 트리',   'PLATINUM', 'V',  2, 2, 512, 'O(E log E)', 410,  120,  110,  5),
    ('S1-01', 'S1-01', '괄호',             'SILVER',   'IV', 1, 1, 256, 'O(N)',       500,  300,  290,  30),
    ('S1-02', 'S1-02', '연속합',           'GOLD',     'V',  1, 1, 256, 'O(N)',       360,  150,  142,  3);
